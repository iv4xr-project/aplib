...
public class GoalLibExtended  extends GoalLib{
	 ...
	 */
	public static GoalStructure useItem(MyAgentState S) {	
	 ...
	 */
	public static GoalStructure entityUsed(MyAgentState S,String targetId){
		//firstly it checks if the selected item is a pot, if not it is a scroll
		System.out.println("use the picked up item! ");	
	
		return  IF(
			 		(MyAgentState x) ->  GoalLibExtended.checkType(x),				 	
	 ...
	 * @return
	 */
	public static boolean checkType(MyAgentState S) {
...
//	    	   	}
	 ...
	 * @return
	 */
	public static GoalStructure scrollInteracted (MyAgentState S, String eId) {
		...
		Action checkShrine = action("checking shrine").do1((MyAgentState A) -> {			
	...
	public GoalStructure makeBagEmpty(MyAgentState b) {
	...
	public static boolean checkTarget(MyAgentState S,Pair p){
	...
	public static GoalStructure entityInCloseRange(MyAgentState b) {
	...
	public static GoalStructure survivalHeuristic(MyAgentState S) {	
