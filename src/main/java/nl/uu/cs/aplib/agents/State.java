...
public class State extends SimpleState {
	 ...
	 * agent can add facts and rules to this engine, and then use it to do inference.
	 * The default to set this field to null.
	 */
	 ...
	 * else you get null).
	 */
	public PrologReasoner prolog() { return prolog ; }
