...
public class Pair<T,U> {
     ...
     * Equals should only be dependent on the variables that are stored in the Pair.
     *
     ...
     * hash(pair(1,2)) should not be equal to hash(pair(2,1)), so the second object is multiplied by 2.
     *
