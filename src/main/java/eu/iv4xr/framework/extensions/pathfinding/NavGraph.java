...
public class NavGraph implements Navigatable {
	...
	/**
	 * Combines the LineIntersectable and Obstacle interface.
	 */
	public interface GraphObstacle extends 
		LineIntersectable, 
		Obstacle { }
	...
	public ArrayList<GraphObstacle> obstacles;
