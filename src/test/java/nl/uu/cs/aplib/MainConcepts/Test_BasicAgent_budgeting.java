...
public class Test_BasicAgent_budgeting {
	...
	public void test_simplescenario() {
	    ...
	    var a0 = action("a0").do1((MyState S)-> { S.counter++ ; return S.counter ; }) ;
	    ...
	    state.counter = 0 ;
        a0 = action("a0").do1((MyState S)-> { S.counter++ ; return S.counter ; }) ;
	...
	public void test_exhaustingbudget_on_multiplegoals() {
	    ...
	    var a0 = action("a0").do1((MyState S)-> {S.counter = 5 ; return S.counter ; }) ;
	    
	    var a1 = action("a1").do1((MyState S)-> {S.counter++ ; return S.counter ; }) ;
