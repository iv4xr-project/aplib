...
public class Test_ForAll {
	...
	public Pair<Boolean, Long> testFullPlay(String agentId, Pair targetItemOrShrine, Pair additionalFeature, int seed ) throws Exception {
				...
				S -> {
					...
					if (player.getPreviousState() != null) {
						...
						if((targetItemOrShrine.fst.equals("type") && targetItemOrShrine.snd.equals(EntityType.HEALPOT) ) ) {
						  ...
						  //specific type in specific level or color ...
